...
<template>
    <div class="bg-white inline-block rounded hover:shadow-[0_0_10px_3px_rgba(0,0,0,0.15)] cursor-pointer">
        <NuxtLink :to="`/item/${product.id}`">
            ...
            <div id="ProductDetails">
                ...
                <div class="flex items-center gap-1 px-1 relative -top-1">
                    <span class="bg-primary text-white text-xs font-semibold px-1.5 rounded-sm">Welcome Deal</span>
                    <span class="bg-[#F5F5F5] border text-secondary text-xs font-semibold px-1.5 rounded-sm">Top Selling</span>
                </div>
                <p class="flex items-center px-1 pt-0.5 text-[#252525]">
